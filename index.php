...
<html>
    <head>
        <!--Source location for the userside input verification-->
        <script src="empty.js"></script>
        <!--Title of page-->
        <title>Granblue Fantasy</title>
    </head>
<!--Changing background colour of the HTML page-->
<body bgcolor="c9e9f6">
    ...
    <!-- action /comment.php to add entries to database -->
    <!-- also on submit runs checkEmpty() function found in a different .js file -->
